...
pub enum DirectMsgArgs {
    ...
    PowerPsciReq32 {
        function_id: u32,
        // params[i]: Input parameter in wi/xi in PSCI function invocation at EL3.
        params: [u32; 3],
    },
    // Message for a power management operation initiated by a PSCI function
    PowerPsciReq64 {
...
impl DirectMsgArgs {
    ...
    const FWK_MSG_BITS: u32 = 0x8000_0000;
    ...
    // b’0: Exit from a suspend to RAM state, b’1: Exit from a low power state shallower than the suspend to RAM state
