...
TARGETS="boot_info_v1_1 boot_info_v1_2 interface_v1_1 interface_v1_2 mem_relinquish_desc mem_transaction_desc notification_info_get32 notification_info_get64 partition_info"
