...
have been moved to a separate document (link above). The crate refers to this as `FF-A MM` when it's
necessary to distinguish between this an the base specification.
